...
#block[
  ...
  #colbreak()
    ...
    #block[
      ...
      #align(center, pad(y: -4em, image("images/file11.png", width: 120%)))
    ]
    #colbreak()
    ...
    #block[
      ...
      #v(4em)
      #align(center, image("images/file12.png", width: 100%))
    ]
    #colbreak()
    ...
    #block[
      ...
      #align(center, pad(y: -4em, image("images/file13.png", width: 120%)))
    ]
    #colbreak()
    ...
    #block[
      ...
      #align(center+bottom, pad( image("images/file14.png", width: 120%)))
    ]
    #colbreak()
    ...
    #pakl(heading(level:2)[pakala], [      jan li kama lon la pakala li lon
    ...
    #block[
      ...
      #align(center, pad(top: -4em, bottom: -3em, image("images/file15.png", width: 128%)))
    ]
    #colbreak()
    ...
    #let mnst(kheading, ktext, kloc) = [
      ...
      #mnst(heading(level: 2)[monsuta insa], [ monsuta li lon insa pi pilin mi \
    ...
    #tokipini(heading(level: 2)[sina suli], [  
