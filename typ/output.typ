...
#let nanpa(loc, nimi, jan: false) = [
  ...
  #link(loc)[
      ...
      #block(breakable: false)[
        #pad(text(size: 0.7em, style: "italic")[#jan])
        #v(0.05em)
        #grid(
          columns: (auto, 1fr, 0.5em, auto),
          par()[#if jan != false [#text(size: 0.9em, weight: 500)[#nimi]] else [#nimi]],
          block[],
          grid.cell(colspan: 2, align: bottom, text(size: 0.7em)[#context [#h(1em)#locate(loc).page()]]),
        )
      ]]
    ...
    #grid(
      ...
      block[],
      grid.cell(colspan: 2, align: bottom, text(size: 0.7em)[#context [#locate(loc).page()]]),
    )
...
#let nanpainsa(loc, nimi, first: false) = [
  #set text(size: 0.8em)
  #if(first){v(0.3em)}

  #pad(top: 0.25em)[#nanpa(loc, nimi)]
]

#let nanpaiinsa(loc, nimi, first: false) = [
  #set text(size: 0.9em)

  #nanpainsa(loc, nimi, first: first)
]
...
#columns(2, gutter: 2em)[
  ...
  - #pad(top: 1em)[#text(weight: 600)[#nanpa(<lipu-lili.xhtml>, "lipu lili")]]
    ...
    - #nanpa(<entries.xhtml.toc_28>, "telo pi tenpo mun nanpa lili", jan: "jan Samele")
  ...
  - #pad(top: 1em)[#text(weight: 600)[#nanpa(<lipu-suli.xhtml>, "lipu suli")]]
    - #nanpa(<ch002.xhtml.id.akesi-li-moku-e-suno>, "akesi li moku e suno", jan: "jan Peli")
      - #nanpainsa(<ch003.xhtml.toc_2>, "jan pali", first: true)
      - #nanpainsa(<ch003.xhtml.toc_3>, "sona pi jan Kepen")
      - #nanpainsa(<ch003.xhtml.toc_4>, "tawa suli")
      - #nanpainsa(<ch003.xhtml.toc_1>, "utala pi akesi sewi")
      - #nanpainsa(<ch003.xhtml.toc_5>, "pini")
    - #nanpa(<ch004.xhtml>, "jan sama tu tu en soweli monsuta", jan: "jan Kepeliju")
      - #nanpainsa(<ch005.xhtml.ona-pi-sitelen-pona>, "sitelen pona", first: true)
      - #nanpainsa(<ch005.xhtml.sitelen-Lasina>, "sitelen Lasina")
    ...
    - #nanpa(<ch008.xhtml>, "kon tu li toki", jan: "jan Ana en jan Lapate")
      ...
      - #nanpainsa(<ch009.xhtml.toc_4>, "ma kasi la mi lukin e jan tu pi ma Aten")
      - #nanpainsa(<ch009.xhtml.toc_5>, "tenpo pi kama lete")
      - #nanpainsa(<ch009.xhtml.toc_6>, "seli loje")
      - #nanpainsa(<ch009.xhtml.toc_7>, "pilin weka")
      - #nanpainsa(<ch009.xhtml.toc_8>, "tenpo pi kalama ala")
      - #nanpainsa(<ch009.xhtml.toc_9>, "pali pi sitelen toki")
      - #nanpainsa(<ch009.xhtml.toc_10>, "tenpo suno sewi")
      - #nanpainsa(<ch009.xhtml.toc_11>, "ijo ale li wile sike")
      - #nanpainsa(<ch009.xhtml.toc_12>, "mi kute e sona pi jan sona Posino")
    ...
    - #nanpa(<ch014.xhtml>, "lon lape", jan: "palisa jelo Natan")
      ...
      - #nanpainsa(<ch015.xhtml.Lasina>, "sitelen Lasina")
    - #nanpa(<ch016.xhtml>, "meli tu pi lawa ante", jan: "mu Esitense usawi")
    - #nanpa(<ch018.xhtml>, "mi lukin e mi lon insa \noko ona", jan: "jan Uli")
      - #nanpainsa(<ch019.xhtml.toc_1>, "kipisi nanpa wan", first: true)
      - #nanpainsa(<ch019.xhtml.toc_2>, "kipisi nanpa tu")
      - #nanpainsa(<ch019.xhtml.toc_3>, "kipisi nanpa tu wan")
      - #nanpainsa(<ch019.xhtml.toc_4>, "kipisi nanpa tu tu")
      - #nanpainsa(<ch019.xhtml.toc_5>, "kipisi nanpa luka")
    - #nanpa(<ch020.xhtml>, "monsuta tu wan li lon tomo pi pona sewi", jan: "akesi Tala")
      - #nanpainsa(<ch021.xhtml.toc_1>, "sitelen pona", first: true)
        - #nanpaiinsa(<ch021.xhtml.toc_1>, "monsuta li lon", first: true)
        - #nanpaiinsa(<ch021.xhtml.toc_3>, "lupa sike")
        - #nanpaiinsa(<ch021.xhtml.toc_4>, "meli pakala Luna")
        - #nanpaiinsa(<ch021.xhtml.toc_5>, "poki sike telo")
        - #nanpaiinsa(<ch021.xhtml.toc_6>, "lupa en kasi kule")
        - #nanpaiinsa(<ch021.xhtml.toc_7>, "jan sin nasa")
        - #nanpaiinsa(<ch021.xhtml.toc_8>, "toki tan jan tu wan")
        - #nanpaiinsa(<ch021.xhtml.toc_9>, "monsuta li pini")
      - #nanpainsa(<ch021.xhtml.monsuta-li-lon-1>, "sitelen Lasina")
        - #nanpaiinsa(<ch021.xhtml.monsuta-li-lon-1>, "monsuta li lon", first: true)
        - #nanpaiinsa(<ch021.xhtml.toc_10>, "lupa sike")
        - #nanpaiinsa(<ch021.xhtml.toc_11>, "meli pakala Luna")
        - #nanpaiinsa(<ch021.xhtml.toc_13>, "poki sike telo")
        - #nanpaiinsa(<ch021.xhtml.toc_14>, "lupa en kasi kule")
        - #nanpaiinsa(<ch021.xhtml.toc_15>, "jan sin nasa")
        - #nanpaiinsa(<ch021.xhtml.toc_16>, "toki tan jan tu wan")
        - #nanpaiinsa(<ch021.xhtml.toc_12>, "monsuta li pini")
    ...
    - #nanpa(<ch032.xhtml>, "tenpo o pona", jan: "jan Ke Tami")
      - #nanpainsa(<ch033.xhtml.lipu-pi-sitelen-pona>, "sitelen pona", first: true)
      - #nanpainsa(<ch033.xhtml.lasinaLtokini>, "sitelen Lasina")
    - #nanpa(<ch034.xhtml>, "TLT (tonsi li tonsi)", jan: "waso Seko")
    - #nanpa(<ch036.xhtml>, "utala insa", jan: "jan Petokota")
      - #nanpainsa(<ch037.xhtml.o-len>, "o len", first: true)
      - #nanpainsa(<ch037.xhtml.twn>, "tawa wawa nasa", first: true)
      - #nanpainsa(<ch037.xhtml.nolin>, "nasin olin", first: true)
      - #nanpainsa(<ch037.xhtml.pakl>, "pakala", first: true)
      - #nanpainsa(<ch037.xhtml.minsa>, "monsuta insa", first: true)
...
#block[
  ...
  #block[
    ...
    #grid(
      columns: (1fr, 1fr),
      block(text(size: 0.9em, font: "nasin-nanpa")[
  ...
  #colbreak()
  #block[
    == ale li kama lon kepeken seme?  <entries.xhtml.toc_4>
    tan jan Alan
  ...
  #block[
    ...
    #pad(top: 3em)[#table(
        columns: 2,
        align: (col, row) => (auto, auto).at(col),
        [jan li kama tawa lon], [lon li pona namako],
        [sewi la ale li laso], [laso li telo suno],
        [telo la jan li kala], [kala li tawa musi],
        [ma la jan li soweli], [soweli li lape suwi],
        [poka noka mute li kasi], [kasi li len pona],
        [kule mute li sitelen len], [len li selo ona],
        [sike jelo li kama anpa], [anpa li linja utala],
        [sewi en anpa li wan], [wan pi kule sama],
      )
    ]
  ...
  #block[
    ...
    #align(center)[
      ...
      #box(width: 15em, grid(
        ...
        align(left, text[o ale, o ale, o ale]),
      ))]]
      #colbreak()
...
#let compute(lipuInp, janInp, donot: false) = {
  lipu.update(lipuInp)
  jan.update(janInp)
  if(donot == true){
    return
...
#compute("akesi li moku e suno", "jan Peli", donot: true)
...
#let openLsitelenLasina(loc) = [
  #place(top + left, dy: -1em, text(
    size: 0.8em,
    style: "italic",
  link(loc)[sitelen Lasina: lipu \##context [#locate(loc).page()]]))
]
...
#block[
  ...
  #block[
    ...
    #grid(
      columns: (1fr, 1fr),
      block[lon poka pi telo suli la, \
...
#block[
  ...
  #show line: it => {
    pad(y: 0.75em, align(center, text(
      size: 0.9em,
    )[‧˚₊꒷꒦︶︶︶︶︶꒷꒦︶︶︶︶︶꒦꒷‧₊˚⊹‧˚₊꒷꒦︶︶︶︶︶꒷꒦︶︶︶︶︶꒦꒷‧₊˚⊹]))
  }
  ...
  #show heading.where(level: 2): it => (
    place(right, dy: -1em, text(size: 0.6em, weight: 300, box(
      stroke: (paint: black, thickness: 0.05em),
      inset: 0.5em,
      it,
    )))
  )
...
#compute("tenpo o pona", "jan Ke Tami")


= tenpo o pona <ch032.xhtml>
...
#block[
  ...
  #block[
    ...
    #align(center, pad(y: -6em, image("images/file19.jpg", width: 132%))) <ch036.xhtml>
  ]
  #colbreak()
  ...
  #block[
    ...
    #align(center, pad(y: -4em, image("images/file11.png", width: 120%))) <ch037.xhtml.o-len>
  ]
  #colbreak()
  ...
  #block[
    ...
    #v(4em)
    #align(center, image("images/file12.png", width: 100%)) <ch037.xhtml.twn>
  ]
  #colbreak()
  ...
  #block[
    ...
    #align(center, pad(y: -4em, image("images/file13.png", width: 120%))) <ch037.xhtml.nolin>
  ]
  #colbreak()
  ...
  #block[
    ...
    #align(center + bottom, pad(image("images/file14.png", width: 120%)))<ch037.xhtml.pakl>
  ]
  #colbreak()


  #let pakl(kheading, ktext, kloc) = [
    #pad()[
      #set text(size: 0.9em)
      #v(1fr)
      #grid(
  ...
  #block[
    ...
    #align(center, pad(top: -4em, bottom: -3em, image("images/file15.png", width: 128%))) <ch037.xhtml.minsa>
  ]
  #colbreak()



  #let mnst(kheading, ktext, kloc) = [
    #pad(top: 2em, left: 4em, bottom: 4em)[
  ...
  #block[
    #place(center, dy: -5em, dx: 5em, box(fill: black, height: 200%, width: 200%))


  ]
  #colbreak()

  #let pini(kheading, ktext, kloc) = [
  ...
  #let tokipini(kheading, ktext, kloc) = [
    #align(center + horizon)[
      #v(1fr)
...
#compute("utala linja", "jan Lakuse")

= utala linja
<ch038.xhtml.id.utala-linja>
#njan("jan Lakuse") <ch038.xhtml>
...
#compute("waso lili li lon insa pi tomo waso", "jan Pasijan")


= waso lili li lon insa pi tomo waso <ch040.xhtml>

#njan("jan Pasijan") <ch040.xhtml.id.waso-lili-li-lon-insa-pi-tomo-waso>
